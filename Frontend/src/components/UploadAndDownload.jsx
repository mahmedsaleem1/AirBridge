...
function FileUploadForm() {
  ...
  try {
    ...
    const response = await fetch(`${import.meta.env.VITE_VERCEL_URL}/api/v1/file/single-file`, {
      method: 'POST',
...
const handleMultipleFileSubmit = async () => {
  ...
  try {
    ...
    // Send to backend
    const response = await fetch(`${import.meta.env.VITE_VERCEL_URL}/api/v1/file/multiple-files`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
